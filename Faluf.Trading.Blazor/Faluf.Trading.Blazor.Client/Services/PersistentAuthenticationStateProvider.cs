using Faluf.Trading.Core.DTOs.Outputs;
...
internal class PersistentAuthenticationStateProvider : AuthenticationStateProvider
{
	...
	public PersistentAuthenticationStateProvider(PersistentComponentState state)
	{
		...
		authenticationStateTask = Task.FromResult(new AuthenticationState(new ClaimsPrincipal(new ClaimsIdentity(claims, "jwtAuthType"))));
	}
